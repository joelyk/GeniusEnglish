window.GENIUS_MODULES = [
  {
    ...
    questions: [
      ...
      {
        prompt:
          "Which of the following best explains what happens to a person's vision when they are farsighted?",
        choices: [
          "They can see things up close but not far away.",
          "They can see things far away but not up close.",
          "They cannot see things far away or up close.",
          "They can see everything as far as the eye can see."
        ],
        answer: 1,
        explanation:
      ...
      {
        prompt:
          "If a person can see up close, but may need glasses to see far away, which of the following conditions do they have?",
      ...
      },
      {
        ...
        choices: ["Inner ear", "Middle ear", "Outer ear", "Upper ear"],
        answer: 1,
        explanation:
          "Le tympan est dans l'oreille moyenne (middle ear). Rappel : outer ear = partie visible, inner ear = tubes/passages vers le cerveau."
      },
      {
        prompt:
          "Which of the following best explains how cilia works with the sense of smell?",
        choices: [
          "Helps with the taste of food",
          "Helps filter the food a person eats",
          "Helps filter the air a person breathes out",
          "Helps filter the air a person breathes in"
        ],
        answer: 3,
        explanation:
      ...
      {
        prompt:
          "Salty, sweet, sour, bitter, hot, cold, creamy, crunchy, and dry are all related to which of the following senses?",
    ...
    questions: [
      {
        ...
        choices: [
          "A method used by scientists to try and find the answers to questions.",
          "Used by scientists only throughout the world.",
          "A method to prove the right answer to a question by a scientist.",
          "The steps scientists use and follow when trying to solve a problem or to prove or disprove a theory."
        ],
        answer: 3,
        explanation:
      ...
      },
      {
        ...
        choices: [
          "Do hamsters live longer than birds?",
          "Cars and trucks usually use the same amount of gasoline.",
          "I think dogs make better pets for everyone.",
          "Brand B lightbulb will burn longer in a lamp than Brand X lightbulb."
        ],
        answer: 3,
        explanation:
      ...
      },
      {
        ...
        choices: [
          "An experiment is a test which will either challenge or support a hypothesis.",
          "An experiment is a test which must always prove the hypothesis.",
          "An experiment is only used when trying to prove a hypothesis.",
          "An experiment does not have to be part of the scientific method."
        ],
        answer: 0,
        explanation:
      ...
      {
        prompt:
          "Fill in the blank with one of the choices. If the results of an experiment support the hypothesis a(n) __________ can be written.",
      ...
      },
      {
        ...
        choices: [
          "Can be used for simple experiments or more difficult experiments",
          "Can be used only for simple experiments at home or in the classroom",
          "Can only be used for experiments carried out by scientists",
          "Can only be used for very difficult experiments"
        ],
        answer: 0,
        explanation:
